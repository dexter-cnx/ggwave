...
abstract interface class GgWaveTransport {
  ...
  Future<Float32List> encode(Uint8List data, {GgWaveProtocol protocol = GgWaveProtocol.audibleFast, int volume = 60});
  Future<void> play(Float32List waveform);
  Future<void> startListening({GgWaveProtocol protocol = GgWaveProtocol.audibleFast});
